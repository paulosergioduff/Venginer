...
dsp=new Array();
dsp[dsp.length]='<tr><td></td><td %bgc><a href="%link" target="%target">%title</a></font></td></tr>';
dsp[dsp.length]='<tr><td></td><td %bgc>%title</font></td></tr>';
// Descrição:
...
for(i=0;i<d[2]+1;i++)
 { pga[pga.length]=' <a href="search.php'+ext+i+'">'+ltx+'</a>\n';
   ltx=i+2;
   if(i==(d[2]-1) && i>(d[3]+7))
    ltx="  Próxima >>";
 };
