...
<?php
		...
		<table border=0 cellpadding="5" id="tbResultados">
			<tr>
				...
				<td class="tbTitulo"><a href="search.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@nome&by=<?=$byC?>">Nome</a></td>
				<td class="tbTitulo">Telefone</td>
				<td class="tbTitulo">Celular</td>
				<td class="tbTitulo"><a href="search.php?opc=<?=$opc?>&buscar=<?=$buscar?>&id=<?=$id?>&action=buscar&order=@email&by=<?=$byC?>">E-mail</a></td>
...
<?php
		...
		<p class="alert"><a href="search.php">Voltar</a></p><br />
<?php
		}else{?>
			<p class="alert">Contato n&atilde;o cadastrado!</p>
			<p class="alert"><a href="search.php">Voltar</a></p>
<?php	}?>            
