...
<meta property="og:image" content="http://i1.ytimg.com/vi/<?php echo $idvideo; ?>/0.jpg"/>
<meta property="og:site_name" content="David Walsh Blog"/>
<meta property="og:description" content="Facebook's Open Graph protocol allows for w">
...
// **** User Defined Display nnummerrar <tr><td>%num.</td> score  Score: %score (pontos)
dsp=new Array();
dsp[dsp.length]='<tr><td></td><td %bgc>%title</font></td>%description</tr>';
// Descrição:
dsp[dsp.length]='<tr><td align="right"></td><td %bgc><color="green">%description</td></color></tr>';
//dsp[dsp.length]='<tr><td align="right">Palavras-chave:</td><td %bgc>%keywords</td></tr>';
//dsp[dsp.length]='<tr><td align="right">Categoria:</td><td %bgc>%dbase</td></tr>';
...
if(fnd.length>0) document.write(' vídeos anunciados nesta categoria</td></tr><br>');
...
for(i=0;i<fnd.length;i++)
 if(fnd[i][0]>-1 && i>=d[0] && i<d[1])
  { for(j=0;j<dsp.length;j++)
     { n=fnd[i][0];
    op[0]=new Array("%link",fnd[i][1]); // item[n][1]+item[n][0]); 
